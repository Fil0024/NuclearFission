...
Pomiar widma promieniowania $\alpha$ przeprowadzono po odpomowaniu powietrza między tarczą uranową a próbką z wykorzystaniem pompy próżniowej. Pomiar trwał godzinę i ostatecznie otrzymano histogram widoczny na Rysunku \ref{fig:pomiar_alpha}. Zarejestrowane widmo obrazuje naturalną promieniotwórczość izotopów wchodzących w skład tarczy.


\begin{figure}[!htbp]
\centering
\includegraphics[width=0.8\textwidth]{pomiar_alpha.pdf}
\caption{Histogram z pomiaru aktywności promieniowania alpha w próbce uranowej.}\label{fig:pomiar_alpha}
\end{figure}
